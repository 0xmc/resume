...
Los Gatos, CA, US
\begin{outerlist}
\item[] \textit{\textbf{Director of Infrastructure Platform}}
  \hfill November 2020 to present
  \begin{innerlist}
  \item Build and operate the compute and storage control plane
  \item Continue responsibilities from previous position
  \end{innerlist}
