...
\item[] \textit{\textbf{Engineering Manager, Network Tools}}
  ...
  \begin{innerlist}
  \item Build and operate the management platform for all Open Connect networks
  \item Organize network information and make it accessible and useful throughout Netflix
  \end{innerlist}
