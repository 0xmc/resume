...
\item[] \textit{\textbf{Manager of Network Tools}}
  ...
  \begin{innerlist}
  \item Leading a team of high performance engineers
  \item Building systems for network flow collection and analysis
  \item Building systems for programmatic device configuration
  \item Building systems for programmatic network maintenance and repair
  \end{innerlist}
\end{outerlist}
