...
%% %% Sanitized
\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
  San Francisco, CA                     %& \textit{Mobile:} (123) 456-7890\\
                                         & \textit{E-mail:} %
  \href{mailto:m@expertknobtwiddlers.com}{m@expertknobtwiddlers.com}\\
\end{tabular}
...
Los Gatos, CA, US
\begin{outerlist}
\item[] \textit{\textbf{Manager of Network Tools}}
  \hfill July 2016 to present
  \begin{innerlist}
  \item Build and operate the management platform for all Open Connect Network and System Infrastructure (OC NSI) networks
  \item Build and operate the bare metal compute and storage control plane
  \item Organize OC NSI information and make it accessible and useful throughout Netflix
  \end{innerlist}
\end{outerlist}
...
\href{http://www.penteledata.net/}{\textbf{PenTeleData}},
Palmerton, PA, US
\begin{outerlist}
...
New York, NY, US
\begin{outerlist}
\item[] M.S., \href{http://www.cs.columbia.edu/}{Computer Science}, 2012
\end{outerlist}

\blankline

\href{http://www.bucknell.edu/}{\textbf{Bucknell University}},
Lewisburg, PA, US
\begin{outerlist}
\item[] B.S.,
  \href{http://www.bucknell.edu/x13768.xml}{Electrical Engineering} and B.A.,
  \href{http://www.bucknell.edu/x731.xml}{Physics}, 2001
  \begin{innerlist}
...
\href{http://www.nottingham.ac.uk/}{\textbf{University of Nottingham}},
Nottingham, UK
\begin{outerlist}
\item[] \href{http://www.bucknell.edu/x9138.xml}{The Nottingham-Bucknell Engineering Exchange}
\end{outerlist}
